...
const Text = ({ variant = 'paragraph1', children = null, tag = 'span', href = '', ...props }: TextProps) => {
  if (href) {
    return (
      <TextBase
        as={Link}
...
interface TextProps {
  ...
  href?: string;
  tag: 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'p' | 'li' | 'a' | 'span' | 'ul' | 'input';
  // tag: string;
  variant: 'hugeTitle' | 'title' | 'subTitle' | 'paragraph1' | 'paragraph2' | 'smallestException' | 'buttonText';
}
